...
export function MenuBar({
  ...
  const menus: Record<string, MenuItem[]> = {
    ...
    View: [
      ...
      { label: '', separator: true },
      { label: 'Live Preview', action: () => onSetEditorMode('preview'), checked: editorMode === 'preview' },
      { label: 'Source Mode', action: () => onSetEditorMode('source'), checked: editorMode === 'source' },
      { label: 'Reading Mode', action: () => onSetEditorMode('reading'), checked: editorMode === 'reading' },
      { label: '', separator: true },
