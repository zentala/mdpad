...
export function MenuBar({
  ...
  const menus: Record<string, MenuItem[]> = {
    ...
    View: [
      ...
      { label: '', separator: true },
      { label: 'Visual Editor', action: () => onSetEditorMode('visual'), checked: editorMode === 'visual' },
      { label: 'Code Editor', action: () => onSetEditorMode('code'), checked: editorMode === 'code' },
      { label: 'Read Mode', action: () => onSetEditorMode('read'), checked: editorMode === 'read' },
      { label: '', separator: true },
